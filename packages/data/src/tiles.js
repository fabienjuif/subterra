...
export default [
  { tile: CornerGazTile, remaining: 5 },
  { tile: AlleyWaterTile, remaining: 4 },
  { tile: AlleyTile, remaining: 4 },
  { tile: CrossWaterTile, remaining: 2 },
  { tile: CornerLandslideTile36, remaining: 1 },
  { tile: EdgeLandslideTile23, remaining: 1 },
  { tile: CornerLandslideTile26, remaining: 1 },
  { tile: CrossTile, remaining: 3 },
  { tile: EdgeWaterTile, remaining: 2 },
  { tile: DeadEndEnemyTile, remaining: 6 },
  { tile: AlleyTightTile, remaining: 3 },
  { tile: DeadEndTile, remaining: 2 },
  { tile: CornerTile, remaining: 4 },
  { tile: AlleyFallTile, remaining: 3 },
  { tile: EdgeLandslideTile16, remaining: 1 },
  { tile: AlleyBlockTile, remaining: 3 },
  { tile: EdgeTile, remaining: 3 },
  { tile: CrossDamageTile, remaining: 2 },
  { tile: AlleyGazTile, remaining: 1 },
  { tile: EdgeGazTile, remaining: 2 },
  { tile: EdgeLandslideTile35, remaining: 1 },
  { tile: EdgeLandslideTile45, remaining: 1 },
  { tile: EdgeLandslideTile13, remaining: 1 },
  { tile: CornerLandslideTile12, remaining: 1 },
  { tile: EdgeLandslideTile46, remaining: 1 },
  { tile: EdgeLandslideTile25, remaining: 2 },
  { tile: CornerLandslideTile15, remaining: 1 },
  { tile: CornerEnemyTile, remaining: 2 },
]
